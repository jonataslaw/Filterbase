package com.edit.photomovie.render;

import android.opengl.GLES20;
import android.opengl.GLSurfaceView;
import com.edit.photomovie.opengl.GLES20Canvas;
...
public class GLSurfaceMovieRenderer extends GLMovieRenderer implements GLSurfaceView.Renderer {
    ...
    /**
     * 无GLSurfaceView的构造函数用于{@link com.edit.photomovie.record.GLMovieRecorder},会在外部设置GLES输出的Surface
     */
